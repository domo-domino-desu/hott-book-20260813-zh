...
随后，Guillaume Brunerie 和 Dan Licata 对一般理论作出了重要贡献，尤其是找到了在计算机证明助理中表示它们并用其开展同伦论的便捷方法（参见 \cref{cha:homotopy}）。
...
像 \Coq 和 \Agda 这样的证明助理\index{proof!assistant}内置了普通的归纳类型，但尚未内置高阶归纳类型。
